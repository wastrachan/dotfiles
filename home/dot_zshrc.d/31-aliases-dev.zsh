...
alias kctx="kubectx"
alias kns="kubens"
alias kexec-prod="kubectx gke_buzzsaw-prod_us-east4_prod-cluster; kubectl exec -it deployments/buzzsaw-backend --"
alias kshell-prod="kexec-prod python manage.py shell"
alias kexec-staging="kubectx gke_buzzsaw-staging_us-east4_staging-cluster; kubectl exec -it deployments/buzzsaw-staging-backend --"
